...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(2, width / 2 - 100, i + 24, stringtranslate.translateKey("menu.mods")));
        controlList.add(new GuiButton(3, width / 2 - 100, i + 48 + 12, 98, 20, stringtranslate.translateKey("menu.options")));
        controlList.add(new GuiButton(4, width / 2 + 2, i + 48 + 12, 98, 20, stringtranslate.translateKey("menu.quit")));
        controlList.add(new GuiButtonLanguage(0, width / 2 - 124, i + 48 + 12));
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        drawString(fontRenderer, "Created by Anya_Smirnova", 2, height - 10, 0xffffff);
