...
ModLoader.addRecipe(new ItemStack(Item.diamond, 1), new Object [] {"NNN", "NNN", "NNN", 'N', mod_FemiCraft.DiamondNugget});
...
ModLoader.addShapelessRecipe(new ItemStack(mod_FemiCraft.DiamondNugget, 9), new Object[] {Item.diamond});
