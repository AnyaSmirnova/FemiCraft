...
public class EntityList
{
    ...
    static
    {
        ...
        addMapping(net.minecraft.src.EntitySnowman.class, "SnowMan", 97, 0xf9f9f9, 0xf6b201);
        addMapping(net.minecraft.src.EntityOcelot.class, "Ozelot", 98, 0xefde7d, 0x564434);
        addMapping(net.minecraft.src.EntityIronGolem.class, "VillagerGolem", 99, 0xd7d3d3, 0x799c65);
